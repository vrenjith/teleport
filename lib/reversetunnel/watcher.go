...
func (c *RemoteClusterWatcherConfig) CheckAndSetDefaults() error {
	if c.AuthClient == nil {
		return trace.BadParameter("missing AuthClient in RemoteClusterWatcherConfig")
	}
	if c.AccessPoint == nil {
		return trace.BadParameter("missing AccessPoint in RemoteClusterWatcherConfig")
	}
	if c.HostSigner == nil {
		return trace.BadParameter("missing HostSigner in RemoteClusterWatcherConfig")
	}
	if c.HostUUID == "" {
		return trace.BadParameter("missing HostUUID in RemoteClusterWatcherConfig")
	}
	if c.LocalCluster == "" {
		return trace.BadParameter("missing LocalCluster in RemoteClusterWatcherConfig")
	}
	if c.ReverseTunnelServer == nil {
		return trace.BadParameter("missing ReverseTunnelServer in RemoteClusterWatcherConfig")
	}
	if c.Clock == nil {
...
func NewRemoteClusterWatcher(cfg RemoteClusterWatcherConfig) (*RemoteClusterWatcher, error) {
...
func (w *RemoteClusterWatcher) realNewAgentPool(ctx context.Context, cluster, addr string) (*AgentPool, error) {
